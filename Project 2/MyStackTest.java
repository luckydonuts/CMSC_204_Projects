...
public class MyStackTest {
	...
	public void testPopStudent() {
		try {
			assertEquals(130.0, doubleS.pop(),.0);
			assertEquals(12.0, doubleS.pop(),.0);
			assertEquals(3.0, doubleS.pop(),.0);
			//Queue is empty, next statement should cause QueueUnderFlowException
			doubleS.pop();
			assertTrue("This should have caused an StackUnderflowException", false);
		}
	...
	public void testPushStudent() {
		try {
			...
			assertEquals(true, doubleS.push(66.0));
	...
	public void testToStringStudent() throws StackOverflowException {
		String toStringStack = doubleS.toString();
		assertEquals(toStringStack, "3.012.0130.0");
		doubleS.push(20.0);
		assertEquals(doubleS.toString(), "3.012.0130.020.0");
		doubleS.push(66.0);
		assertEquals(doubleS.toString(), "3.012.0130.020.066.0");
	}
