...
public class BasicDoubleLinkedList_STUDENT_Test{
	...
	public void setUp() throws Exception {
		...
		linkedString.addToEnd("Golf");
		linkedString.addToEnd("Round");
	...
	public void testAddToEnd() {
		assertEquals("Round", linkedString.getLast());
	...
	public void testAddToFront() {
		assertEquals("Golf", linkedString.getFirst());
	...
	public void testIteratorSuccessfulNext() {
		...
		assertEquals("Golf", iterator.next());
	...
	public void testRetrieveFirstElement() {
		...
		assertEquals("Golf",linkedString.getFirst());
		assertEquals("Golf", linkedString.retrieveFirstElement());
		assertEquals("Round",linkedString.getFirst());
